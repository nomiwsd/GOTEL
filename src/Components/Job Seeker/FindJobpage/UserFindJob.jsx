                                        ...
                                        return(
                                            ...
                                            <div class="jobs-header d-flex justify-content-between p-0">
                                                <div class="jobs-header-left d-flex justify-content-between p-0">
                                                    <img class="logo-company" src={img} alt="" />
                                                    <div class="jobs-left-inner mx-3">
                                                        <h3 class="jobs-title"><Link to='../Singlejob'>{job.jobTitle}</Link>
                                                        </h3>
                                                        <div class="info-company d-flex ">
                                                            <p >by <a class="authour civi-link-bottom mx-2" href="https://civi.uxper.co/companies/software/uxper/">{job.jobCompany}</a> in
