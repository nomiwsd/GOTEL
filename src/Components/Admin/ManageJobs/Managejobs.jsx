            ...
            <div className='jobpostsection row d-flex m-0 p-0'>
                ...
                <div className="bg-color px-3 py-2">
                    ...
                    <div className="row d-flex m-0 p-0">
                        <div class="select-box  m-0 p-0 me-2">
                            <div class="select-box__current" tabindex="1">
                                <div class="select-box__value">
                                    <input class="select-box__input col-5" type="radio" id="0" value="1" name="Ben" checked="checked" />
                        ...
                        <div className="search d-none d-md-flex col-2 border-1 rounded-4">
                        <SearchOutlinedIcon className='fs-4 mt-1' />
